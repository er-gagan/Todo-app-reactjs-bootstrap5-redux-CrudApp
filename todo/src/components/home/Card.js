...
const Card = () => {
    ...
    const openbtn = (ids, titles, descs) => {
        setId(ids)
        setTitle(titles)
        setDesc(descs)
    }
    const todoUpdate = () => {
        ...
        dispatch(updateTodo({ id: newId, title: newTitle, desc: newDesc }))
    }
                                ...
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-body">
                                            <input type="text" id="newId" onChange={(e) => setId(e.target.value)} value={id} />
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <textarea type="text" className="form-control" id="editDesc" onChange={(e) => setDesc(e.target.value)} value={desc} ></textarea>
                                            </div>
                                        </div>
